...
# # adding inbound traffic rules to created security groups
...
#     to_port           = 3306
#     protocol          = "tcp"
#     source_security_group_id = module.backend.sg_id # source is where you are getting traffice from
...
#     to_port           = 3306
#     protocol          = "tcp"
#     source_security_group_id = module.bastion.sg_id # source is where you are getting traffice from
#     security_group_id = module.db.sg_id
# }
...
#     to_port           = 3306
#     protocol          = "tcp"
#     source_security_group_id = module.vpn.sg_id # source is where you are getting traffice from
#     security_group_id = module.db.sg_id
# }
...
#     to_port           = 8080
#     protocol          = "tcp"
#     source_security_group_id = module.app_alb.sg_id # source is where you are getting traffice from
...
#     to_port           = 80
#     protocol          = "tcp"
#     cidr_blocks       = ["0.0.0.0/0"] # there is no source here traffic is coming from public/internet
